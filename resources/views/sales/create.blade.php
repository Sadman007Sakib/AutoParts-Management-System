      ...
      <div class="card shadow-sm">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <small class="text-muted">Create sale / generate slip</small>
          </div>
          ...
          <form method="POST" action="{{ route('sales.store') }}">
            ...
            <div class="table-responsive mb-3">
              <table class="table table-borderless align-middle" id="sale-items">
                ...
                <tbody>
                  <tr>
                    <td>
                      <select name="items[0][part_id]" class="form-select">
                    ...
                    <td><input name="items[0][price]" type="number" step="0.01" class="form-control price-input"></td>
                    <td><input name="items[0][quantity]" type="number" min="1" class="form-control qty-input" value="1"></td>
            ...
            <div class="row g-3 align-items-end mb-3">
              ...
              <div class="col-md-3">
                ...
                <input type="number" step="0.01" min="0" id="discount_value" name="discount_value" class="form-control" value="0">
              </div>

              <div class="col-md-3">
                <label class="form-label">Tax Rate (%)</label>
                <input type="number" step="0.01" min="0" id="tax_rate" name="tax_rate" class="form-control" value="{{ config('shop.tax_rate', 0) }}">
              </div>
            ...
            <div class="mb-3 d-flex gap-2">
              ...
              <a href="{{ route('parts.index') }}" class="btn btn-outline-secondary ms-auto">Cancel</a>
